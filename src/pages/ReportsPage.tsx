      ...
      {tab === 'weekly' && (
        <ReportCard
          ...
          rows={[
            ...
            { label: 'Omega 3', value: `${weekly.omega3Compliance}%`, tone: weekly.omega3Compliance >= 70 ? 'good' : 'bad' },
            { label: 'Protein shakes', value: `${weekly.proteinDays} / ${db.settings.weeklyProteinTarget}`, tone: weekly.proteinDays >= db.settings.weeklyProteinTarget ? 'good' : 'warn' },
            { label: 'Weigh-ins', value: `${weekly.weighIns} / ${db.settings.weeklyWeightTarget}`, tone: weekly.weighIns >= db.settings.weeklyWeightTarget ? 'good' : 'warn' },
      ...
      {tab === 'monthly' && (
        <ReportCard
          ...
          rows={[
            ...
            { label: 'Omega 3', value: `${monthly.omega3Compliance}%`, tone: monthly.omega3Compliance >= 70 ? 'good' : 'bad' },
